...
export const TestCard = ({ test }: TestCardProps) => {
  return (
    <div className="flex flex-col bg-white rounded-xl py-6 px-4 border-1 border-[#E2E8F0] hover:shadow-md transition-shadow duration-300 gap-y-3 md:h-full">
      ...
      <div className="flex flex-col sm:flex-row gap-x-4 gap-y-2">
        <div className="flex items-center text-gray-600 gap-x-1.5">
